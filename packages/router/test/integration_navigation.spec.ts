...
import {NavigationStateManager} from '../src/statemanager/navigation_state_manager';
import {StateManager} from '../src/statemanager/state_manager';
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        {provide: StateManager, useClass: NavigationStateManager},
      ]
    });
  });
